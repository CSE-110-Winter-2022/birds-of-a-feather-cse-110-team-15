...
public class OneClassInCommonTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void oneClassInCommonTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.course_number_textview),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("21"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.course_number_textview), withText("100"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("105"));
